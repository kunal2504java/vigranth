  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        ...
        >
          UnifyInbox connects every messaging platform into one AI-ranked feed. Gmail, Slack, Discord, Telegram — prioritized by what actually matters. Draft and send without switching tabs.
        </motion.p>
