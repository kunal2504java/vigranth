...
function StatusLine() {
  ...
  return (
    <div className="flex items-center gap-2 text-[10px] tracking-widest text-muted-foreground uppercase font-mono">
      ...
      <span>messages processed: {throughput}k today</span>
    </div>
  )
}
...
const TIERS: Tier[] = [
  {
    ...
    period: "/ forever",
    tag: null,
    description: "Get started with 2 platforms and 50 messages per day.",
    features: [
      { text: "2 platforms connected", included: true },
      { text: "50 messages / day", included: true },
      { text: "5 AI draft replies / day", included: true },
      { text: "3 VIP contacts", included: true },
      { text: "Thread summarization", included: false },
  ...
  },
  {
    ...
    period: "/ month",
    tag: "MOST POPULAR",
    description: "All platforms. Unlimited messages. Full AI power.",
    features: [
      { text: "All 7+ platforms", included: true },
      { text: "Unlimited messages", included: true },
      { text: "Unlimited AI drafts", included: true },
      { text: "Unlimited VIP contacts", included: true },
  ...
  },
  {
    ...
    period: "/ month",
    tag: null,
    description: "Shared team inbox. Delegation. Team analytics.",
    features: [
      { text: "Everything in Pro", included: true },
      { text: "Shared team inbox", included: true },
      { text: "Message delegation", included: true },
      { text: "Team analytics", included: true },
      { text: "Response time tracking", included: true },
...
export function PricingSection() {
  return (
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            All plans include AI priority ranking, cross-platform send, and snooze &amp; mark-done actions.
          </p>
        </div>
        <StatusLine />
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* All plans billed monthly. Cancel anytime. Your data stays yours."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
