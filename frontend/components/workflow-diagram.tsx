...
const LEFT_LABELS = ["Ingest", "Normalize", "Classify"]
const RIGHT_LABELS = ["Rank", "Draft", "Send"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing the message pipeline: Ingest, Normalize, Classify, Rank, Draft, Send"
      >
