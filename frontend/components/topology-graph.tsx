...
const NODES: Node[] = [
  { id: "ingest", label: "INGEST", x: 80, y: 180 },
  { id: "classify", label: "CLASSIFY", x: 260, y: 80 },
  { id: "rank", label: "RANK", x: 440, y: 180 },
  { id: "sentiment", label: "SENTIMENT", x: 260, y: 280 },
  { id: "draft", label: "DRAFT", x: 620, y: 180 },
]
...
export function TopologyGraph() {
  ...
  return (
    <div className="relative w-full border-2 border-foreground bg-background">
      <svg viewBox="0 0 760 360" className="w-full h-auto" role="img" aria-label="UnifyInbox agent pipeline showing message flow from Ingest through Classify and Sentiment to Rank and Draft">
