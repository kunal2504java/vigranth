  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="7" label="Platforms Connected" delay={500} />
        <ScrambleNumber target="2.5K" label="Messages / day" delay={800} />
        <ScrambleNumber target="85%" label="Priority Accuracy" delay={1100} />
        <ScrambleNumber target="60%" label="Drafts Sent Unchanged" delay={1400} />
      </div>
    </div>
  )
}
